      ...
      <div class="main-wrapper">
        <div class="main">
          <div class="logo-container">
            <img src="../assets/icon-left-font.png" class="logo" alt="Logo de l'entreprise Groupomania" />
          </div>
          ...
          <div class="container-post_block">
            <div v-for="title in posts" :key="title" class="post-block" :id="title.id" @click="getOnePost(title.id)">
              <div class="user_bloc">
                <div v-if="title.User.picture !== null">
                  <span>
                    <img :src="title.User.picture" class="picture_post" alt="Image du post"
                  /></span>
                </div>
              ...
              <div class="comment">
                <i class="fas fa-comment"  @click="showComments"></i>
                ...
                >
                  <div v-if="comment.post_id == title.id">
                    ...
                    <button
                      v-if="id == comment.user_id || isAdmin == 1"
                      class="button_bloc"
